...
import { ActivityAlternative, ActivityAlternativeRequest, TripPlannerRequest, TripPlanResponse, TripScenario, TripScenarioItem } from '@app/core/models/trip-planner.model';
